...
def main():
   ...
   .sidebar .sidebar-content {
    ...
    selection = st.radio("", ['Crop Disease Detection', 'Crop Recommendation','Fertilizer Recommendaton System', 'Crop Price Recommendation', 'Crop Health'])
    st.write("""<style>
    ...
    if selection == 'Crop Health':
        ...
        if st.button("Detect"):
            if file is None:
                ...
                st.success("This Disease is {} ".format(word[1]))
    ...
    elif selection == 'Fertilizer Recommendaton System':
        textbg = """
        <div style="background-color:{};background: rgba(60, 179, 113, 0.8)">
        <h1 style="color:{};text-align:center;"><b>Fertilizer Recommendaton System</b></h1>
        </div>
        """
        bgcolor = ''
        fontcolor = 'white'
